 ...
 * 
 *  <CODE>EmailUtility.email(Collection<String> users, message, subject);</CODE>
 *
...
//            props.put("mail.smtp.starttls.enable", "true");// See documentation
 ...
 //           mailSession.setDebug(true); // Gives detailed output
            ...
            if(SMTP_AUTH_USER == null || !SMTP_AUTH_USER.isEmpty())
                    message.setFrom(new InternetAddress("GreenPowerProject@bloomu.edu"));
        ...
        //   Debug.println("Adding #"+toAddress+"#");
           ...
           ErrorLogger.log(Level.SEVERE, 
             "Could not send mail in email(Collection<String> recipients, String mailMessage, String subject)", ex);
        }
    }
